package org.flixel
{
	...
	public class FlxPoint
	{
		...
		/**
		 * Add point values to another and return a new point
		 * 
		 * @param	point	The point values to add
		 */
		public function add(point:FlxPoint):FlxPoint
		{
			return new FlxPoint(x + point.x, y + point.y);
		}
