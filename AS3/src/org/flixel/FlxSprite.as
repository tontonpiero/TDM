package org.flixel
{
	...
	public class FlxSprite extends FlxObject
	{
		...
		*/
		 ...
		 */
		public function drawCircle(Center:FlxPoint, Radius:Number = 30, LineColor:uint = 0xffffffff, LineThickness:uint = 1, FillColor:uint = 0xffffffff):void {
		...
		{
			_pixels.fillRect(new Rectangle(0, 0, _pixels.width, _pixels.height), 0x00000000);
		}
